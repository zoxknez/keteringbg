...
export default async function AdminDashboard() {
  ...
  const stats = [
    { label: 'Ukupno Jela', value: dishCount, icon: UtensilsCrossed, color: 'amber' as const },
    { label: 'Menija', value: menuCount, icon: BookOpen, color: 'blue' as const },
    { label: 'Narudžbina', value: orderCount, icon: ShoppingCart, color: 'green' as const },
    { label: 'Ovog Meseca', value: growthFormatted, icon: TrendingUp, color: 'purple' as const },
  ]
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className={`w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-xl ${colors.bg} flex items-center justify-center`}>
              ...
              >
                ...
                <div className="flex items-center gap-2 md:gap-4 ml-4">
                  <div className="text-right hidden sm:block">
                    <p className={`text-sm font-medium ${order.status === 'COMPLETED' ? 'text-green-500' :
                  ...
                  {/* Mobile status dot */}
                  <div className={`sm:hidden w-3 h-3 rounded-full ${order.status === 'COMPLETED' ? 'bg-green-500' :
